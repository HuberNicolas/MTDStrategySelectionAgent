...
def main():
    ...
    parser.add_argument(
        "--extensions",
        "--e",
        help="This specifies which file types should have their extensions "
    ...
    parser.add_argument(
        "--recursive",
        "--r",
        help="This boolean value specifies if file extensions should be changed "
        "for subdirectories as well in a recursive manner.",
        default=False,
        action="store_true",
    )
...
def change_file_extensions(directory, dictionary_ext_to_pext, doRecursive):
    ...
    for file in files:
        ...
        if len(file_split) > 1 and file_split[1] in dictionary_ext_to_pext.keys():
            ...
            except:  # noqa: E722 — best-effort rename; ignore files that cannot be renamed
                pass
